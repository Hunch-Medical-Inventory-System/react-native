...
import { updateInventory } from '@/store/tables/inventorySlice'; // Assuming the thunk is in the "thunks" file.
...
const EditData = ({
  toggleModal, // Function passed as a prop to update modal visibility
